...
async def test_empty_list_returns_empty_dict():
    result = await get_display_names_for_discord_ids([])
    assert result == {}
...
async def test_missing_id_absent_from_result():
    ...
    result = await get_display_names_for_discord_ids(["999999999999999999"])
    assert result == {}
...
async def test_present_id_returns_display_name():
    ...
    result = await get_display_names_for_discord_ids(["111111111111111111"])
...
async def test_mixed_present_and_missing():
    ...
    result = await get_display_names_for_discord_ids(["222222222222222222", "000000000000000000"])
...
async def test_multiple_present_ids():
    ...
    result = await get_display_names_for_discord_ids(["333333333333333333", "444444444444444444"])
