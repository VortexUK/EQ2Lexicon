...
from census.db import _like_escape as items_like_escape
from census.recipes_db import _like_escape as recipes_like_escape
from census.spells_db import _like_escape as spells_like_escape
