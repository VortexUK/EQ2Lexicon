...
from web.db import review_claim, submit_claim, upsert_server_settings_sync, upsert_user
...
def test_cache_key_helper_is_world_scoped():
    ...
    from web.routes.claim import _claim_cache_key
...
async def test_varsoon_subdomain_returns_only_varsoon_claims(app, monkeypatch):
    ...
    from web.routes import claim as claim_mod
