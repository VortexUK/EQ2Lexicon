...
from backend.census.models import (
    AAProfile,
    AdornSlot,
    CharacterAAs,
    CharacterOverview,
...
def _build_trace_config() -> aiohttp.TraceConfig:
    ...
    async def _on_end(
        ...
        try:
            from backend.server.metrics import CENSUS_DURATION, CENSUS_REQUESTS, census_endpoint_label
    ...
    async def _on_exception(
        ...
        try:
            from backend.server.metrics import CENSUS_REQUESTS, census_endpoint_label
