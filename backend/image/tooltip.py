...
from backend.census.models import ItemData, ItemEffect, ItemStat
...
_SLOT_BACKDROP_PATH = Path(__file__).resolve().parent.parent.parent / "data" / "AAs" / "slot-empty-blue.png"
