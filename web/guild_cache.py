...
def _prewarm_adorn_cache(
    ...
    from web.routes.guild import (  # noqa: PLC0415
        AdornColorStats,
...
async def _fetch_and_cache_guild(
    ...
    async def _do_fetch():
        ...
        from web.routes.character import (  # noqa: PLC0415
...
async def _persist_and_publish_guild(guild_name: str, world: str | None = None) -> None:
    ...
    from web.routes.guild import GuildMemberResponse, GuildResponse  # noqa: PLC0415
